...
class OTPStackView: UIStackView {
    ...
    //Colors
    let inactiveFieldBorderColor = #colorLiteral(red: 0, green: 0, blue: 0, alpha: 0)
    let textBackgroundColor = #colorLiteral(red: 0, green: 0, blue: 0, alpha: 0)
    let activeFieldBorderColor = #colorLiteral(red: 0, green: 0, blue: 0, alpha: 0)
