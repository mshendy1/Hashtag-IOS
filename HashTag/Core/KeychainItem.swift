...
struct KeychainItem {
    ...
    static var currentUserName: String {
        do {
            let storedIdentifier = try KeychainItem(service: "com.example.apple-samplecode.juice", account: "userName").readItem()
            return storedIdentifier
        } catch {
            return ""
        }
    ...
    static var currentUserEmail: String {
        do {
            let storedIdentifier = try KeychainItem(service: "com.example.apple-samplecode.juice", account: "userEmail").readItem()
            return storedIdentifier
        } catch {
            return ""
        }
