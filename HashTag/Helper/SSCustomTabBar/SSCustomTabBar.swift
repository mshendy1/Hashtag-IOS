...
public class SSCustomTabBar: UITabBar {
    ...
    func setArabicLayer()
    {
        tabBarShapeLayer.transform = CATransform3DMakeScale(-1, 1, 1)
    ...
    func customeLayout()
    {
        ...
        unselectedTabTintColor = UIColor(hex: "9396A3")
        waveHeight = 21.0
        cornerRadius = 41
       shadowColor2 = UIColor(hex: "EBF1F4")
    ...
    /// Shadow Color
    @IBInspectable var shadowColor2: UIColor {
        get {
    ...
    /// Shadow Radius
    @IBInspectable var shadowRadius2: CGFloat {
        get {
    ...
    /// Shadow Offset
    @IBInspectable var shadowOffset2: CGSize {
        get {
